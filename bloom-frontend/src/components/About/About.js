...
const About = () => {
  return (
      ...
      <section className="vision-section">
        <h2>Our Vision</h2>
        <p>
          We envision a beautiful world where mental health is much prioritized, where individuals feel empowered to take charge of their well-being, and where the stigma surrounding mental health is eradicated. 
