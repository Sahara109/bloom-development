...
const About = () => {
  return (
      ...
      <section className="vision-section">
        <h2>Our Vision</h2>
        <p>
          We envision a world where mental health is prioritized, where individuals feel empowered to take charge of their well-being, and where the stigma surrounding mental health is eradicated. 
          At BLOOM, we strive to create a space where users can find solace, support, and inspiration.
        </p>
      </section>
      ...
      <section className="mission-section">
        <h2>Our Mission</h2>
        <p>
          Our mission at BLOOM is simple: to provide mental health support and resources for all. 
          We believe that mental wellbeing should be as prioritized as physical health, and we’re committed to helping people understand and manage their mental health better.
        </p>
      </section>
     ...
     <section className="team-section">
      ...
      <section className="cta-section">
        <p>Whether you are seeking information, looking for support or just need a moment of calm, BLOOM is right here for you. Join us on this journey towards better mental health and well-being. Become a part of BLOOM today!</p>
